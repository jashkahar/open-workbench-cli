...
$env:GOOS="darwin"; $env:GOARCH="amd64"; go build -o om-darwin-amd64 main.go tui.go
...
$env:GOOS="darwin"; $env:GOARCH="arm64"; go build -o om-darwin-arm64 main.go tui.go
...
$env:GOOS="linux"; $env:GOARCH="amd64"; go build -o om-linux-amd64 main.go tui.go
...
$env:GOOS="windows"; $env:GOARCH="amd64"; go build -o om-windows-amd64.exe main.go tui.go
